<x-filament-panels::page>
    @php($records = \App\Models\Invitation::query()->whereHas('inviter', fn($q) => $q->where('role', 'vendor')->whereKey(auth()->id()))->latest()->limit(20)->get())
    <x-filament::section :heading="__('filament.admin.pages.vendor_invitations.heading')">
        <div class="space-y-2">
