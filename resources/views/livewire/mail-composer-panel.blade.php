<div class="space-y-3">
    ...
    <div class="rounded-xl border border-gray-200 p-3 dark:border-white/10">
        ...
        <div class="grid grid-cols-1 gap-2 lg:grid-cols-4">
            <select wire:model.live="recordType" class="fi-input">
            ...
            <x-filament::button type="button" size="sm" color="info" wire:click="insertRecordLink">Insert Link</x-filament::button>
        </div>
        <select wire:model="recordSelection" class="fi-input mt-2 block w-full">
